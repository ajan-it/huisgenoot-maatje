# Audit bundle — huisgenoot-maatje

Generated: (fill date/time here)

---

## 1) Edge Function — plan-generate
**Path:** `supabase/functions/plan-generate/index.ts`
```ts
// START PASTE plan-generate HERE
