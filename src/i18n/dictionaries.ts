export const dictionaries = {
  nl: {
    ...
    tasks: {
      ...
      picker: {
        ...
        selectedTasksHelp: "Aantal huishoudtaken die je hebt gekozen",
        weeklyTimePerPerson: "Wekelijkse Tijd Per Persoon",
        budgetUsage: "Tijdsbudget Gebruik",
        budgetUsageHelp: "Hoeveel van je beschikbare tijdsbudget wordt gebruikt",
        activeTasks: "Actieve taken",
        estimatedMinutes: "Geschatte minuten p.p. per week",
        fairnessPreview: "Eerlijkheidsvoorbeeld",
        overcommitted: "Overschot van {hours}u - overweeg taken te verminderen",
        overcommittedSuggestion: "Verwijder enkele taken of verhoog je tijdsbudget in stap 3",
  ...
  en: {
    ...
    tasks: {
      ...
      packs: {
        pack_no_kids: "No kids",
        pack_toddler: "Toddler 1-3",
        pack_schoolkids: "School kid(s)",
        ...
        pack_season_spring: "Spring seasonal check",
        pack_season_autumn: "Autumn seasonal check",
        pack_cycling: "Bicycle",
        pack_car: "Car",
      ...
      picker: {
        ...
        selectedTasksHelp: "Number of household tasks you've chosen to include",
        weeklyTimePerPerson: "Weekly Time Per Person",
        budgetUsage: "% of Time Budget Used",
        budgetUsageHelp: "How much of your available time budget will be used",
        activeTasks: "Active tasks",
        estimatedMinutes: "Estimated minutes p.p. per week",
        fairnessPreview: "Fairness preview",
        overcommitted: "Overcommitted by {hours}h - consider reducing tasks",
        overcommittedSuggestion: "Remove some tasks or increase your time budget in step 3",
        whyThisFrequency: "Why this suggestion?",
        helperText: "Info",
    ...
    notFound: {
      ...
      metaTitle: "Weekly plan created | Household",
      ...
      startWizard: "Start wizard",
      backHome: "Back to home",
      h1: "Weekly plan created 🎉",
      successPrefix: "Your plan for the week starting",
      ...
      whyBody: "The fairness score compares the workload per adult with the set time budgets and task preferences. The goal is a balanced distribution that is also practically feasible.",
      restart: "Start over",
      ...
      cancel: "Cancel",
      inviteCopiedTitle: "Invitation copied",
      inviteCopiedDesc: "Send the link to your partner.",
      gcalText: "Weekly household tasks plan",
      gcalDetails: "Automatically generated weekly plan",
      icsSummary: "Weekly household tasks plan",
